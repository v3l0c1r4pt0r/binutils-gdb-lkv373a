...
insn_descr_t opcodes[] = {
  ...
  /* 06 */ {op_6, "unk6", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 07 */ {op_7, "unk7", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 08 */ {op_8, "unk8", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  ...
  /* 11 */ {op_11, "unk11", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  ...
  /* 21 */ {op_21, "unk21", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  ...
  /* 27 */ {op_27, "unk27", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 28 */ {op_28, "unk28", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 29 */ {op_29, "unk29", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 2a */ {op_2a, "unk2A", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  ...
  /* 2f */ {op_2f, "unk2F", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  ...
  /* 35 */ {op_35, "unk35", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 36 */ {op_36, "unk36", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 37 */ {op_37, "unk37", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 38 */ {op_38, "unk38", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
  /* 39 */ {op_39, "unk39", first_invalid_type, &rd_u, &rs_u, &rb_u, &imm_u},
